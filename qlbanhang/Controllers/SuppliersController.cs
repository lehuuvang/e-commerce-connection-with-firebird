...
namespace qlbanhang.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(DNorthwindFdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Suppliers != null ? 
                          ...
                          Problem("Entity set 'DNorthwindFdbContext.Suppliers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DNorthwindFdbContext.Suppliers'  is null.");
            }
            var supplier = await _context.Suppliers.FindAsync(id);
            if (supplier != null)
            {
